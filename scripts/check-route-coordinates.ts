 ...
 * the map drew it in the Gulf of Guinea. Found in iRam Route Planner on 6 Aug 2026 ("Makro Woodmead is in the
 * middle of the ocean") and ported here — Clippa shares this engine.
 *
