 ...
 * the page remounts on every keystroke and steals focus from the input beside it.
 */
function CheckAddressOnGoogle({ address }: { address?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 rounded border border-gray-200 px-2 py-1 text-xs font-medium text-clippa-red transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:border-gray-100 disabled:text-gray-300"
    >
    ...
    <div className="p-6 max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="relative group">
            {user.profilePicUrl ? (
              ...
              <div className="w-20 h-20 rounded-full bg-clippa-red flex items-center justify-center text-white text-xl font-bold border-2 border-gray-200">
          ...
          <div>
            ...
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium mt-1 bg-clippa-red/10 text-clippa-red">
              {roleLabel(user.role)}
            </span>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex items-center gap-4 mt-4">
          <button
            onClick={saveProfile}
            disabled={saving}
            className="px-4 py-2 bg-clippa-red text-white text-sm font-medium rounded-lg hover:bg-red-700 disabled:opacity-50 transition-colors"
          >
      ...
      {rep && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          {/* Current state, said plainly — a rep should never have to guess
              whether this is set */}
          <div
          ...
          >
            <svg
              className={`mt-0.5 h-4 w-4 flex-shrink-0 ${rep.hasCoordinates ? "text-green-600" : "text-amber-500"}`}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth={2}
          ...
          <div className="mt-5 border-t border-gray-100 pt-4">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-clippa-red px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-700 disabled:opacity-50"
            >
