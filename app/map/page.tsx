 ...
 *
 * A plain <select> is unusable once the rep list runs to the hundreds — the
 * native list has no filtering, so finding one person means scrolling a wall of
 * names. Matches on name and code, because reps are identified by code
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-1.5 text-sm font-semibold hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-clippa-red min-w-44"
