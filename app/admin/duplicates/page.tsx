      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        ...
        {data && data.removableCount > 0 && (
          <button
            onClick={apply}
            disabled={applying}
            className="bg-clippa-red text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-700 disabled:opacity-50 flex-shrink-0"
          >
            {applying ? "Removing..." : `Remove ${data.removableCount} duplicate records`}
          </button>
        )}
      </div>
