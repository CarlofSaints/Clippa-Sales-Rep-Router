      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <div className="flex items-center gap-3">
          <input
            ...
            className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-clippa-red"
          />
          <button
            onClick={addRegion}
                  ...
                  <td className="px-6 py-3">
                    {editing === region.id ? (
                      <input
                        ...
                        className="border border-gray-200 rounded px-2 py-1 text-sm w-full max-w-xs focus:outline-none focus:ring-1 focus:ring-clippa-red"
                        autoFocus
                      />
                    ) : (
