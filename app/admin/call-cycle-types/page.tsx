    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="bg-clippa-red text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          + Add Type
        </button>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-clippa-red resize-none"
              />
            </div>
          </div>
          <div className="mt-4 flex gap-2">
            <button onClick={addType} disabled={saving} className="bg-clippa-red text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-700 disabled:opacity-50">
                    ...
                    {isEditing ? (
                      <div className="space-y-3">
                        <input
                          ...
                          className="w-full border border-gray-200 rounded-lg px-3 py-1.5 text-sm font-semibold focus:outline-none focus:ring-1 focus:ring-clippa-red"
                        />
                        <textarea
                          value={editData.description}
                          onChange={(e) => setEditData({ ...editData, description: e.target.value })}
                          rows={2}
                          className="w-full border border-gray-200 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-clippa-red resize-none"
                        />
                        <div className="flex gap-2">
                          <button
                    ...
                    <button
                      ...
                      className={`text-sm font-medium px-4 py-1.5 rounded-lg transition-colors ${
                        t.active
                          ...
                          : "bg-clippa-red/10 text-clippa-red hover:bg-clippa-red/20"
                      }`}
                    >
                      {activating === t.id ? (
                        <span className="flex items-center gap-2">
                          <span className="inline-block w-3 h-3 border border-clippa-red border-t-transparent rounded-full animate-spin" />
                          Activating...
                        </span>
                      ) : t.active ? (
                        "Currently Active"
