...
const TOP_NAV = [
  ...
  { href: "/rep-activity", label: "Rep Sales & Activity", icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
  ...
  { href: "/not-in-cycle", label: "Not in a Cycle", icon: "M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" },
...
const CONTROL_CENTRE_NAV = [
  ...
  // Next to Channels on purpose: it is the same idea applied to the other axis.
  // Channels decide which SHOPS a rep calls on; this decides which CODES are a
  // rep at all.
  { href: "/admin/rep-codes", label: "Rep Codes", icon: "M7 20l4-16m2 16l4-16M6 9h14M4 15h14" },
  ...
  { href: "/admin/ims", label: "IMS Reconciliation", icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
  { href: "/admin/sql-direct", label: "SQL Direct", icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" },
  { href: "/admin/commission", label: "Commission", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
