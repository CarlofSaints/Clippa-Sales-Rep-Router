...
// NOTE: best-guess Repsly "Import Schedules" column layout. Confirm against the
// Download-template header row from Repsly and adjust here if needed.
const HEADERS = [
  "Representative ID",
  "Place ID",
  "From Date",
...
export async function GET(request: NextRequest) {
  try {
    ...
    const base = `Repsly_CallCycle_${scope}_${months}mo_${date}`;
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Repsly Schedule");
