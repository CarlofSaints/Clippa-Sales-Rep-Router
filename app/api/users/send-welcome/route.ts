...
export async function POST(request: NextRequest) {
  try {
    ...
    const tempPassword = `Clippa${Math.random().toString(36).slice(2, 8)}!`;
...
Welcome to Clippa Sales Rep Router!

Your login credentials:
- URL: ${process.env.NEXT_PUBLIC_APP_URL || "https://clippa-sales-rep-router.vercel.app"}
- Email: ${user.email}
