...
export async function POST(request: NextRequest) {
  try {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Validate frequency
      // parseFrequency is deliberately forgiving about case, spacing and
      // wording — these files are typed by hand, and a whole import used to
      // fail on "Weekly" vs "weekly".
