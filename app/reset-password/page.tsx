  ...
  if (checking) {
    return (
      <div className="flex justify-center py-8">
        <div className="h-7 w-7 animate-spin rounded-full border-2 border-clippa-red border-t-transparent" />
      </div>
    );
  }
    ...
    return (
      <>
        ...
        <a
          ...
          className="mt-5 block w-full rounded-lg bg-clippa-red px-4 py-2.5 text-center text-sm font-medium text-white transition-colors hover:bg-red-700"
        >
          Sign in
        </a>
      </>
    ...
    <>
      ...
      <form onSubmit={submit} className="mt-5">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-clippa-red"
        />
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-clippa-red px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-red-700 disabled:opacity-50"
        >
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex justify-center">
          <Image src="/clippa-logo.jpg" alt="Clippa Sales" width={180} height={61} className="h-12 w-auto" priority />
        </div>
