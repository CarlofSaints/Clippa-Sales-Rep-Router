        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-clippa-red disabled:bg-gray-50"
            />
          </div>
        </div>
                  ...
                  <tr key={o.id}>
                    ...
                    <td className="px-4 py-2 text-right whitespace-nowrap">
                      ...
                      <button
                        ...
                        className="text-xs font-medium text-clippa-red hover:underline"
                      >
                        Reset
                      </button>
                    </td>
