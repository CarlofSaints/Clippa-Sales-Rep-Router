 ...
 * picture, personnel and sales included, and a sheet without those columns
 * going through it unassigns the rep and zeroes the monthly average on every
 * store it touches. This one posts to /api/stores/import, which reads only the
 * store's own location fields, so the team can fix a column of GPS coordinates
 * in the exported file and send it straight back.
 */
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              <span className="font-medium text-gray-700">
                Reps, teams and the monthly average are never touched.
              </span>
            </p>
          </div>
          <button
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-5 bg-gray-50 border border-gray-100 rounded-xl p-4">
            ...
            <p className="text-[11px] text-gray-400 mt-3">
              Every other column in the exported file is ignored, including the rep and team columns,
              MONTHLY AVERAGE, and FREQUENCY / DURATION / DAY / WEEK. A column you delete from the
              file is left untouched on every store; a column you keep but leave blank clears that
              field. Stores whose Place ID is not already in the system are reported, not created.
            </p>
          </div>
        </div>
      </div>
