  ...
  return (
    <div className="guide-flow">
        ...
        {FLOW_STEPS.map((s, i) => (
          <li key={s.n} className="relative flex gap-4 pb-5 last:pb-0 break-inside-avoid">
            ...
            <span
              ...
              style={{ borderColor: s.accent ? RED : LINE }}
            >
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
                stroke={s.accent ? RED : GREY}
                strokeWidth={1.7}
                aria-hidden="true"
              >
              ...
              <span
                ...
                style={{ background: s.accent ? RED : INK }}
              >
                {s.n}
              </span>
            </span>
            <div className="min-w-0 flex-1 pt-0.5">
              ...
              <p className="text-[11px] font-medium" style={{ color: RED }}>
                {s.where}
              </p>
      ...
      <div
        ...
        style={{ borderColor: "#FCD9D9", background: "#FEF6F6" }}
      >
        <svg className="mt-0.5 h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke={RED} strokeWidth={1.8} aria-hidden="true">
...
export function DataModel() {
  ...
  return (
    <svg viewBox="0 0 620 300" className="w-full" role="img" aria-label="Channels and reps feed stores, which produce the route plan">
      ...
      {/* STORES */}
      {box(235, 95, 175, 110, "#FEF6F6", "#FCD9D9")}
      ...
      <text x="322" y="157" textAnchor="middle" fontSize="10.5" fontWeight="700" fill={RED}>rep code</text>
      ...
      <path d="M170 224 C205 224 205 178 232 172" fill="none" stroke={RED} strokeWidth="2" markerEnd="url(#gm-arrow-red)" />
      <text x="188" y="205" fontSize="9.5" fontWeight="700" fill={RED}>matched by</text>
      <text x="188" y="216" fontSize="9.5" fontWeight="700" fill={RED}>rep code</text>
      ...
      <text x="322" y="238" textAnchor="middle" fontSize="10" fontWeight="600" fill={RED}>
...
export function TwoDoors() {
  const Door = ({
    ...
    <div
      ...
      style={{ borderColor: tone === "red" ? "#FCD9D9" : LINE, background: tone === "red" ? "#FEF6F6" : "#F9FAFB" }}
    >
      <p className="text-sm font-bold" style={{ color: INK }}>{title}</p>
      <p className="text-[11px] font-medium" style={{ color: tone === "red" ? RED : GREY }}>{where}</p>
