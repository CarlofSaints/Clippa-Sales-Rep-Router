...
export const SESSION_COOKIE = "clippa_session";
 ...
 *
 * The cookie is a snapshot taken at login and it lives for 30 days, so
 * promoting someone in /admin changed users.json and nothing else — they kept
 * their old role until they happened to sign out. Anything derived from the
 * role has to come from the user record.
 */
